            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset($post->features)}}" alt="{{$post->title}}">
                            <div class="overlay"></div>
                            <a href="{{$post->features}}" class="link-image js-zoom-image">
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset($secondpost->features)}}" alt="">
                            <div class="overlay"></div>
                            <a href="{{$secondpost->features}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset($thirdpost->features)}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{$thirdpost->features}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
